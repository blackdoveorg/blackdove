...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="flex-shrink-0 flex items-center">
                    <a href="http://localhost:8000/nest">
  ...
  <g inkscape:groupmode="layer" id="layer2" inkscape:label="Layer 2" transform="translate(-88.014523,-75.582695)"></g>
                ...
                @auth
                    <a class="inline-flex items-center px-1 pt-1 border-b-2 border-transparent text-sm font-medium leading-5 text-gray-500 hover:text-gray-700 hover:border-olive focus:outline-none focus:text-gray-700 focus:border-gray-300 transition duration-150 ease-in-out" href="{{ route('nest') }}">
                        Nest
                    </a>
                @else
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        @auth
            <a class="block pl-3 pr-4 py-2 border-l-4 border-transparent text-base font-medium text-gray-600 hover:text-gray-800 hover:bg-gray-50 hover:border-gray-300 focus:outline-none focus:text-gray-800 focus:bg-gray-50 focus:border-gray-300 transition duration-150 ease-in-out" href="{{ route('nest') }}">
                Nest
            </a>
        @else
            @if (Route::has('register'))
    ...
    <input  class="form-input rounded-md shadow-sm mt-1 block w-full form-input rounded-md shadow-sm" readonly="readonly" hidden="hidden" id="ip_latitude" value="41.31" wire:ignore="ip_latitude">
    <input  class="form-input rounded-md shadow-sm mt-1 block form-input rounded-md shadow-sm" readonly="readonly" hidden="hidden" id="ip_longitude" value="-72.92" wire:ignore="ip_longitude">
            </main>
        </div>
